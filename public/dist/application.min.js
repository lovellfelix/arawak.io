...
"use strict";angular.module("core").controller("HomeController",["$scope","$http","$location","Authentication",function($scope,$http,$location,Authentication){$scope.authentication=Authentication,$scope.authentication.user&&$location.path("/dashboard")}]);
...
"use strict";angular.module("dashboard").config(["$stateProvider",function($stateProvider){$stateProvider.state("dashboard",{url:"/dashboard",templateUrl:"modules/dashboard/views/dashboard.client.view.html"})}]);
"use strict";angular.module("dashboard").controller("DashboardController",["$scope",function(){}]);
"use strict";angular.module("huts").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Huts",state:"huts",type:"dropdown"}),Menus.addSubMenuItem("topbar","huts",{title:"List Huts",state:"huts.list"}),Menus.addSubMenuItem("topbar","huts",{title:"Create Hut",state:"huts.create"})}]);
"use strict";angular.module("huts").config(["$stateProvider",function($stateProvider){$stateProvider.state("huts",{"abstract":!0,url:"/huts",template:"<ui-view/>"}).state("huts.list",{url:"",templateUrl:"modules/huts/views/list-huts.client.view.html"}).state("huts.create",{url:"/create",templateUrl:"modules/huts/views/create-hut.client.view.html"}).state("huts.view",{url:"/:hutId",templateUrl:"modules/huts/views/view-hut.client.view.html"}).state("huts.edit",{url:"/:hutId/edit",templateUrl:"modules/huts/views/edit-hut.client.view.html"})}]);
"use strict";angular.module("huts").controller("HutsController",["$scope","$stateParams","$location","Authentication","Huts","MyHuts","Servers","Products","Socket",function($scope,$stateParams,$location,Authentication,Huts,MyHuts,Servers,Products,Socket){$scope.authentication=Authentication,$scope.servers=Servers.query(),$scope.products=Products.query(),$scope.create=function(){var hut=new Huts({name:this.name,product:this.product,server:this.server});hut.$save(function(response){$location.path("huts/"+response._id),$scope.name="",$scope.product="",$scope.server=""},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.remove=function(hut){if(hut){hut.$remove();for(var i in $scope.huts)$scope.huts[i]===hut&&$scope.huts.splice(i,1)}else $scope.hut.$remove(function(){$location.path("dashboard")})},$scope.update=function(){var hut=$scope.hut;hut.$update(function(){$location.path("huts/"+hut._id)},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.find=function(){$scope.huts=Huts.query()},$scope.findMyHuts=function(){$scope.huts=MyHuts.query()},$scope.findOne=function(){$scope.hut=Huts.get({hutId:$stateParams.hutId})},$scope.createHut=function(){var name=document.getElementById("name").value,dbType="monogodb";Socket.emit("createHut",{name:name,type:dbType})},$scope.deleteHut=function(name){Socket.emit("deleteHut",{name:name})},$scope.$on("$destroy",function(){Socket.removeListener("createHut"),Socket.removeListener("deleteHut")})}]);
"use strict";angular.module("huts").filter("Huts",[function(){return function(input){return"Huts filter: "+input}}]);
"use strict";var app=angular.module("huts");app.factory("Huts",["$resource",function($resource){return $resource("api/huts/:hutId",{hutId:"@_id"},{update:{method:"PUT"}})}]),app.factory("MyHuts",["$resource",function($resource){return $resource("api/huts/me")}]);
"use strict";angular.module("products").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Products",state:"products",type:"dropdown"}),Menus.addSubMenuItem("topbar","products",{title:"List Products",state:"products.list"}),Menus.addSubMenuItem("topbar","products",{title:"Create Product",state:"products.create"})}]);
"use strict";angular.module("products").config(["$stateProvider",function($stateProvider){$stateProvider.state("products",{"abstract":!0,url:"/products",template:"<ui-view/>"}).state("products.list",{url:"",templateUrl:"modules/products/views/list-products.client.view.html"}).state("products.create",{url:"/create",templateUrl:"modules/products/views/create-product.client.view.html"}).state("products.view",{url:"/:productId",templateUrl:"modules/products/views/view-product.client.view.html"}).state("products.edit",{url:"/:productId/edit",templateUrl:"modules/products/views/edit-product.client.view.html"})}]);
"use strict";angular.module("products").controller("ProductsController",["$scope","$stateParams","$location","Authentication","Products",function($scope,$stateParams,$location,Authentication,Products){$scope.authentication=Authentication,$scope.create=function(){var product=new Products({name:this.name,version:this.version,description:this.description,repository:this.repository});product.$save(function(response){$location.path("products/"+response._id),$scope.name="",$scope.version="",$scope.description="",$scope.repository=""},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.remove=function(product){if(product){product.$remove();for(var i in $scope.products)$scope.products[i]===product&&$scope.products.splice(i,1)}else $scope.product.$remove(function(){$location.path("products")})},$scope.update=function(){var product=$scope.product;product.$update(function(){$location.path("products/"+product._id)},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.find=function(){$scope.products=Products.query()},$scope.findOne=function(){$scope.product=Products.get({productId:$stateParams.productId})}}]);
...
"use strict";angular.module("servers").config(["$stateProvider",function($stateProvider){$stateProvider.state("servers",{"abstract":!0,url:"/servers",template:"<ui-view/>"}).state("servers.list",{url:"",templateUrl:"modules/servers/views/list-servers.client.view.html"}).state("servers.create",{url:"/create",templateUrl:"modules/servers/views/create-server.client.view.html"}).state("servers.view",{url:"/:serverId",templateUrl:"modules/servers/views/view-server.client.view.html"}).state("servers.edit",{url:"/:serverId/edit",templateUrl:"modules/servers/views/edit-server.client.view.html"})}]);
"use strict";angular.module("servers").controller("ServersController",["$scope","$stateParams","$location","Authentication","Servers",function($scope,$stateParams,$location,Authentication,Servers){$scope.authentication=Authentication,$scope.create=function(){var server=new Servers({name:this.name,hostname:this.hostname,region:this.region});server.$save(function(response){$location.path("servers/"+response._id),$scope.name="",$scope.hostname="",$scope.region=""},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.remove=function(server){if(server){server.$remove();for(var i in $scope.servers)$scope.servers[i]===server&&$scope.servers.splice(i,1)}else $scope.server.$remove(function(){$location.path("servers")})},$scope.update=function(){var server=$scope.server;server.$update(function(){$location.path("servers/"+server._id)},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.find=function(){$scope.servers=Servers.query()},$scope.findOne=function(){$scope.server=Servers.get({serverId:$stateParams.serverId})}}]);
"use strict";angular.module("servers").factory("Servers",["$resource",function($resource){return $resource("api/servers/:serverId",{serverId:"@_id"},{update:{method:"PUT"}})}]);
